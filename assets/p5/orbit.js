...
function setup() {
    ...
    gr.textAlign(CENTER);
    gr.fill('red');
    gr.text('Welcome to the studio of Danny White', windowInnerWidth * 0.66, windowHeight *0.4);

    gr.textAlign(RIGHT);
    gr.text('📱 +1 (626) 657 7733 🇺🇸 • 🇦🇺 +61 490 520 628 📱', windowInnerWidth * 1, windowHeight * 0.25);
    gr.text(`📧 ${basicEmailEncoder()} 📧`, windowInnerWidth * 0.89, windowHeight * 0.75);
...
function draw() {
    ...
    angle -= 0.6;
    rotateY(angle * 0.02);
    sphere(windowInnerWidth * 1, 48, 48)
    pop();
